...
router.post('/', auth, multer, validator.createComment, check.publication, commentCrtl.create);
router.put('/:id', auth, check.comment, multer, validator.modifyComment, check.publication, commentCrtl.modify);
